-- =====================================================
-- CRIAR FUNÇÃO GET_USER_STATS (CORRIGIDA)
-- =====================================================
...
-- 4. Verificar estrutura da tabela auth_users
SELECT 
    column_name,
    data_type,
    is_nullable
...
-- 7. Executar função para testar (substitua pelo UUID real)
-- SELECT * FROM get_user_stats('00000000-0000-0000-0000-000000000000'::UUID);
